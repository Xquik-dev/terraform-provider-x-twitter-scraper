...
type XTweetRetweetModel struct {
	...
	Billing               customfield.NestedObject[XTweetRetweetBillingModel]    `tfsdk:"billing" json:"billing,computed"`
	NextAction            customfield.NestedObject[XTweetRetweetNextActionModel] `tfsdk:"next_action" json:"nextAction,computed"`
	Request               customfield.NestedObject[XTweetRetweetRequestModel]    `tfsdk:"request" json:"request,computed"`
	Result                customfield.NestedObject[XTweetRetweetResultModel]     `tfsdk:"result" json:"result,computed"`
	Target                customfield.NestedObject[XTweetRetweetTargetModel]     `tfsdk:"target" json:"target,computed"`
}
...
type XTweetRetweetBillingModel struct {
	Charged        types.Bool   `tfsdk:"charged" json:"charged,computed"`
	ChargedCredits types.String `tfsdk:"charged_credits" json:"chargedCredits,computed"`
...
type XTweetRetweetNextActionModel struct {
...
type XTweetRetweetRequestModel struct {
...
type XTweetRetweetResultModel struct {
	ID    types.String `tfsdk:"id" json:"id,computed"`
	State types.String `tfsdk:"state" json:"state,computed"`
	Type  types.String `tfsdk:"type" json:"type,computed"`
}

type XTweetRetweetTargetModel struct {
	ID   types.String `tfsdk:"id" json:"id,computed"`
	Type types.String `tfsdk:"type" json:"type,computed"`
}
