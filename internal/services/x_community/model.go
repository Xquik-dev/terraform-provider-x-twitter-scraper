...
type XCommunityModel struct {
	...
	Billing               customfield.NestedObject[XCommunityBillingModel]    `tfsdk:"billing" json:"billing,computed"`
	NextAction            customfield.NestedObject[XCommunityNextActionModel] `tfsdk:"next_action" json:"nextAction,computed"`
	Request               customfield.NestedObject[XCommunityRequestModel]    `tfsdk:"request" json:"request,computed"`
	Result                customfield.NestedObject[XCommunityResultModel]     `tfsdk:"result" json:"result,computed"`
	Target                customfield.NestedObject[XCommunityTargetModel]     `tfsdk:"target" json:"target,computed"`
}
...
type XCommunityBillingModel struct {
	Charged        types.Bool   `tfsdk:"charged" json:"charged,computed"`
	ChargedCredits types.String `tfsdk:"charged_credits" json:"chargedCredits,computed"`
...
type XCommunityNextActionModel struct {
...
type XCommunityRequestModel struct {
...
type XCommunityResultModel struct {
	ID    types.String `tfsdk:"id" json:"id,computed"`
	State types.String `tfsdk:"state" json:"state,computed"`
	Type  types.String `tfsdk:"type" json:"type,computed"`
}

type XCommunityTargetModel struct {
	ID   types.String `tfsdk:"id" json:"id,computed"`
	Type types.String `tfsdk:"type" json:"type,computed"`
}
