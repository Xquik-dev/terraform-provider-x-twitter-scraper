...
type XTweetLikeModel struct {
	...
	Billing               customfield.NestedObject[XTweetLikeBillingModel]    `tfsdk:"billing" json:"billing,computed"`
	NextAction            customfield.NestedObject[XTweetLikeNextActionModel] `tfsdk:"next_action" json:"nextAction,computed"`
	Request               customfield.NestedObject[XTweetLikeRequestModel]    `tfsdk:"request" json:"request,computed"`
	Result                customfield.NestedObject[XTweetLikeResultModel]     `tfsdk:"result" json:"result,computed"`
	Target                customfield.NestedObject[XTweetLikeTargetModel]     `tfsdk:"target" json:"target,computed"`
}
...
type XTweetLikeBillingModel struct {
	Charged        types.Bool   `tfsdk:"charged" json:"charged,computed"`
	ChargedCredits types.String `tfsdk:"charged_credits" json:"chargedCredits,computed"`
...
type XTweetLikeNextActionModel struct {
...
type XTweetLikeRequestModel struct {
...
type XTweetLikeResultModel struct {
	ID    types.String `tfsdk:"id" json:"id,computed"`
	State types.String `tfsdk:"state" json:"state,computed"`
	Type  types.String `tfsdk:"type" json:"type,computed"`
}

type XTweetLikeTargetModel struct {
	ID   types.String `tfsdk:"id" json:"id,computed"`
	Type types.String `tfsdk:"type" json:"type,computed"`
}
