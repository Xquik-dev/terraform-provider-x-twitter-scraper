...
type XWriteActionDataSourceModel struct {
	...
	Account               customfield.NestedObject[XWriteActionAccountDataSourceModel]    `tfsdk:"account" json:"account,computed"`
	Billing               customfield.NestedObject[XWriteActionBillingDataSourceModel]    `tfsdk:"billing" json:"billing,computed"`
	NextAction            customfield.NestedObject[XWriteActionNextActionDataSourceModel] `tfsdk:"next_action" json:"nextAction,computed"`
	Request               customfield.NestedObject[XWriteActionRequestDataSourceModel]    `tfsdk:"request" json:"request,computed"`
	Result                customfield.NestedObject[XWriteActionResultDataSourceModel]     `tfsdk:"result" json:"result,computed"`
	Target                customfield.NestedObject[XWriteActionTargetDataSourceModel]     `tfsdk:"target" json:"target,computed"`
}

type XWriteActionAccountDataSourceModel struct {
	ID       types.String `tfsdk:"id" json:"id,computed"`
	Username types.String `tfsdk:"username" json:"username,computed"`
}

type XWriteActionBillingDataSourceModel struct {
	Charged        types.Bool   `tfsdk:"charged" json:"charged,computed"`
	ChargedCredits types.String `tfsdk:"charged_credits" json:"chargedCredits,computed"`
...
type XWriteActionNextActionDataSourceModel struct {
...
type XWriteActionRequestDataSourceModel struct {
...
type XWriteActionResultDataSourceModel struct {
	ID    types.String `tfsdk:"id" json:"id,computed"`
	State types.String `tfsdk:"state" json:"state,computed"`
	Type  types.String `tfsdk:"type" json:"type,computed"`
}

type XWriteActionTargetDataSourceModel struct {
	ID   types.String `tfsdk:"id" json:"id,computed"`
	Type types.String `tfsdk:"type" json:"type,computed"`
}
