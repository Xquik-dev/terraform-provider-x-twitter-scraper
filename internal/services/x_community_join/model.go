...
type XCommunityJoinModel struct {
	...
	Billing               customfield.NestedObject[XCommunityJoinBillingModel]    `tfsdk:"billing" json:"billing,computed"`
	NextAction            customfield.NestedObject[XCommunityJoinNextActionModel] `tfsdk:"next_action" json:"nextAction,computed"`
	Request               customfield.NestedObject[XCommunityJoinRequestModel]    `tfsdk:"request" json:"request,computed"`
	Result                customfield.NestedObject[XCommunityJoinResultModel]     `tfsdk:"result" json:"result,computed"`
	Target                customfield.NestedObject[XCommunityJoinTargetModel]     `tfsdk:"target" json:"target,computed"`
}
...
type XCommunityJoinBillingModel struct {
	Charged        types.Bool   `tfsdk:"charged" json:"charged,computed"`
	ChargedCredits types.String `tfsdk:"charged_credits" json:"chargedCredits,computed"`
...
type XCommunityJoinNextActionModel struct {
...
type XCommunityJoinRequestModel struct {
...
type XCommunityJoinResultModel struct {
	ID    types.String `tfsdk:"id" json:"id,computed"`
	State types.String `tfsdk:"state" json:"state,computed"`
	Type  types.String `tfsdk:"type" json:"type,computed"`
}

type XCommunityJoinTargetModel struct {
	ID   types.String `tfsdk:"id" json:"id,computed"`
	Type types.String `tfsdk:"type" json:"type,computed"`
}
