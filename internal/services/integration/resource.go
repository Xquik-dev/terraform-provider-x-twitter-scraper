...
var _ resource.ResourceWithConfigure = (*IntegrationResource)(nil)
var _ resource.ResourceWithModifyPlan = (*IntegrationResource)(nil)
...
func (r *IntegrationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	_, err = r.client.Integrations.New(
		ctx,
		xtwitterscraper.IntegrationNewParams{},
...
func (r *IntegrationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	res := new(http.Response)
	_, err = r.client.Integrations.Update(
		ctx,
		data.ID.ValueString(),
...
func (r *IntegrationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	res := new(http.Response)
	_, err := r.client.Integrations.Get(
		ctx,
		data.ID.ValueString(),
		option.WithResponseBodyInto(&res),
		option.WithMiddleware(logging.Middleware(ctx)),
...
func (r *IntegrationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.Integrations.Delete(
		ctx,
		data.ID.ValueString(),
		option.WithMiddleware(logging.Middleware(ctx)),
	)
...
func (r *IntegrationResource) ModifyPlan(_ context.Context, _ resource.ModifyPlanRequest, _ *resource.ModifyPlanResponse) {
