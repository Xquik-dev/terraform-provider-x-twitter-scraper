...
page_title: "x-twitter-scraper_x_community_leave Resource - X Twitter Scraper"
subcategory: ""
description: |-
  Executes one leave_community write and stores only its durable canonical write-action record.
---

# x-twitter-scraper_x_community_leave (Resource)
