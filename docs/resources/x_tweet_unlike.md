...
page_title: "x-twitter-scraper_x_tweet_unlike Resource - X Twitter Scraper"
subcategory: ""
description: |-
  Executes one unlike write and stores only its durable canonical write-action record.
---

# x-twitter-scraper_x_tweet_unlike (Resource)
