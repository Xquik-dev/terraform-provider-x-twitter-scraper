...
page_title: "x-twitter-scraper_x_tweet_delete Resource - X Twitter Scraper"
subcategory: ""
description: |-
  Executes one delete_tweet write and stores only its durable canonical write-action record.
---

# x-twitter-scraper_x_tweet_delete (Resource)
