...
page_title: "x-twitter-scraper_x_profile_banner Resource - X Twitter Scraper"
subcategory: ""
description: |-
  Executes one update_banner write and stores only its durable canonical write-action record.
---

# x-twitter-scraper_x_profile_banner (Resource)
