...
- `media` (List of String) Array of public media URLs to attach. Supports up to 4 images or exactly 1 MP4 video up to 100 MB. Each URL must be publicly reachable. Attached media adds 2 credits per started MB across all files.
...
- `charged` (Boolean)
- `charged_credits` (String) Credits charged for this tweet. Text-only tweets and replies cost 30 credits; attached media adds 2 credits per started MB.
