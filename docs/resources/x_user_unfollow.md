...
page_title: "x-twitter-scraper_x_user_unfollow Resource - X Twitter Scraper"
subcategory: ""
description: |-
  Executes one unfollow write and stores only its durable canonical write-action record.
---

# x-twitter-scraper_x_user_unfollow (Resource)
