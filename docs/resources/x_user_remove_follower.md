...
page_title: "x-twitter-scraper_x_user_remove_follower Resource - X Twitter Scraper"
subcategory: ""
description: |-
  Executes one remove_follower write and stores only its durable canonical write-action record.
---

# x-twitter-scraper_x_user_remove_follower (Resource)
