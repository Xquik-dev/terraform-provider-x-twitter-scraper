...
page_title: "x-twitter-scraper_x_profile_avatar Resource - X Twitter Scraper"
subcategory: ""
description: |-
  Executes one update_avatar write and stores only its durable canonical write-action record.
---

# x-twitter-scraper_x_profile_avatar (Resource)
